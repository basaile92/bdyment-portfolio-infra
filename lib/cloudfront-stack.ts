            ...
            "BdymentPortFolioProdResponseHeaderPolicy",
            {
                ...
                securityHeadersBehavior: {
                    contentSecurityPolicy: {
                        override: true,
                        contentSecurityPolicy: `connect-src 'self' https://${domainName} https://region1.google-analytics.com/g/collect; default-src 'self' 'unsafe-inline' https://www.googletagmanager.com ;`,
                    },
